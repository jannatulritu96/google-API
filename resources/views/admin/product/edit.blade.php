                ...
                <form method="post" class="form-horizontal" action="{{ route('product.update',$product) }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" style="margin-left: 5px;">
                            ...
                            <input type="name" class="form-control"  name="name" placeholder="Name" style="width: 98%;" value="{{ $product->name }}">
                        </div>
                        <div class="form-group" style="margin-left: 5px;">
                            <label for="exampleInputEmail1">details</label>
                            <input type="text" class="form-control"  name="details" placeholder="details" style="width: 98%;" value="{{ $product->details }}">
                        </div>
                        <div class="form-group" style="margin-left: 5px;">
                            <label for="exampleInputEmail1">Original price</label>
                            <input type="number" class="form-control"  id="original_price" name="original_price" placeholder="Original price" style="width: 98%;" value="{{ $product->original_price }}">
                        </div>
                        <div class="form-group" style="margin-left: 5px;">
                        ...
                        <div class="form-group" style="margin-left: 5px;">
                            <label>Color</label>
                            <select class="form-control selectTag" name="product_color[]" multiple="multiple"  value="{{ $product->product_color }}">
                            </select>
                        </div>
